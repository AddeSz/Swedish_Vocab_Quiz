...
public class DuelState
{
  ...
  public bool Player1Disconnected { get; set; }
  public bool Player2Disconnected { get; set; }
  public CancellationTokenSource? Player1ReconnectCts { get; set; }
  public CancellationTokenSource? Player2ReconnectCts { get; set; }
